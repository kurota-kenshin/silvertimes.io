      ...
      <div className="bg-background-secondary/60 backdrop-blur-xl border border-white/10 rounded-2xl px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              <a href="#network" className="px-3 py-1.5 text-sm text-silver-300 hover:text-white transition-colors rounded-lg hover:bg-white/5">
                Network
              </a>
              <a href="#transparency" className="px-3 py-1.5 text-sm text-silver-300 hover:text-white transition-colors rounded-lg hover:bg-white/5">
                Transparency
              </a>
              <a href="#docs" className="px-3 py-1.5 text-sm text-silver-300 hover:text-white transition-colors rounded-lg hover:bg-white/5">
                Docs
              </a>
            </div>
