          ...
          >
            <div className="w-9 h-9 bg-white rounded-lg flex items-center justify-center flex-shrink-0">
              <svg className="w-5 h-5" viewBox="0 0 35 33">
                <path d="M32.958 1l-13.134 9.718 2.442-5.727L32.958 1z" fill="#E17726" />
                <path d="M2.066 1l13.002 9.809L12.758 4.99 2.066 1zm26.132 22.536l-3.495 5.339 7.483 2.06 2.143-7.282-6.13-.117zm-27.112.117l2.127 7.282 7.467-2.06-3.479-5.339-6.115.117z" fill="#E27625" />
                <path d="M10.47 14.515l-2.077 3.14 7.405.337-.247-7.97-5.08 4.493zM24.554 14.515l-5.16-4.586-.168 8.063 7.405-.337-2.077-3.14z" fill="#E27625" />
                <path d="M10.873 27.875l4.463-2.17-3.859-3.009-.604 5.179zm8.814-2.17l4.44 2.17-.581-5.179-3.859 3.009z" fill="#E27625" />
              </svg>
            </div>
