      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-base text-silver-400 max-w-3xl mx-auto">
            A transparent, auditable process from onboarding to earnings
            <br className="hidden md:block" /> with institutional-grade security
            at every step
          </p>
        </div>
            ...
            <div key={index} className="relative group">
              <div className="bg-background-secondary/30 backdrop-blur-sm border border-white/5 rounded-2xl p-8 group-hover:border-white/10 transition-all duration-300 h-full">
                ...
                <div className="flex items-center justify-between mb-6">
                  <div
                    className={`text-5xl font-bold bg-gradient-to-br ${step.gradient} bg-clip-text text-transparent`}
                  >
                    {step.number}
                  </div>
                  <div
                    className={`w-1 h-12 bg-gradient-to-b ${step.gradient
                      .replace("/20", "/60")
                      .replace("/30", "/70")} rounded-full`}
                  ></div>
                </div>
