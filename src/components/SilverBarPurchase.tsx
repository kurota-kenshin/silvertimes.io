        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-base text-silver-400 max-w-3xl mx-auto">
              ...
              <br className="hidden md:block" /> Premium quality 999.9 fine
              silver bars
            </p>
          </div>
              ...
              <div className="space-y-4 text-sm text-silver-400">
                ...
                <div className="pt-4 border-t border-white/5 mt-6">
                  <p className="text-xs text-silver-500 italic">
                    Please note that our silver bars may display marks,
                    abrasions, slight discoloration, or spotting due to
                    oxidation. These features are common results of the
                    manufacturing and handling process. They do not affect the
                    bar's silver content or authenticity. Each bar is produced
                    and certified by SilverTimes to meet recognized industry
                    standards.
                  </p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      SilverTimes' approved list of courier partners.
                      SilverTimes will assist in arranging shipment but will not
                      be liable for delays, damages, or losses once the item is
                ...
                <div className="pt-4 border-t border-white/5">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-violet-400 mt-1.5 flex-shrink-0"></div>
                      <span>
                        Payment accepted in USDT, USDC, or major
                        cryptocurrencies
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="pt-4 border-t border-white/5">
                  <p className="text-xs text-silver-500 italic">
                    * Delivery times may vary based on location and customs
                    processing. International orders may be subject to
